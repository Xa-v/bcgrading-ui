...
<div>
  ...
  <ul class="nav nav-tabs" id="scoreTypeTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button
            class="nav-link disabled {scoreType === 'Quiz' ? 'active' : ''}"
            type="button"
            ...
            <tbody>
                {#each gradelistEntries as yawa}
                    <tr>
                        ...
                        <td>{yawa.QuizScore.quiz_1}</td>
                        <td>{yawa.QuizScore.quiz_2}</td>
                        <td>{yawa.QuizScore.quiz_3}</td>
                        <td>{yawa.QuizScore.quiz_4}</td>
                        <td>{yawa.QuizScore.quiz_5}</td>
                        <td>{yawa.QuizScore.quiz_6}</td>
                        <td>{yawa.QuizScore.quiz_7}</td>
                        <td>{yawa.QuizScore.quiz_8}</td>
                        <td>{yawa.QuizScore.quiz_9}</td>
                        <td>{yawa.QuizScore.quiz_10}</td>
                        <td>{yawa.QuizScore.quiz_total}</td>
                        <td>{yawa.QuizScore.quiz_percentage}</td>
                    </tr>
                {/each}
            </tbody>
        </table>
