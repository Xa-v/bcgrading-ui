...
<div>
  ...
  <ul class="nav nav-tabs" id="scoreTypeTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button
            class="nav-link disabled {scoreType === 'Attendance' ? 'active' : ''}"
            type="button"
            ...
            <tbody>
                {#each gradelistEntries as yawa}
                    <tr>
                        ...
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_2}</td>
                        <td>{yawa.AttendanceScore.attendance_3}</td>
                        <td>{yawa.AttendanceScore.attendance_4}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_1}</td>
                        <td>{yawa.AttendanceScore.attendance_total}</td>
                        <td>{yawa.AttendanceScore.attendance_percentage}</td>
                    </tr>
                {/each}
            </tbody>
        </table>
