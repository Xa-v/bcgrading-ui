...
<div>
  ...
  <ul class="nav nav-tabs" id="scoreTypeTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button
            class="nav-link disabled {scoreType === 'Participation' ? 'active' : ''}"
            type="button"
    ...
    <li class="nav-item" role="presentation">
        <button
            class="nav-link {scoreType === 'Project' ? 'active' : ''}"
            type="button"
            ...
            <tbody>
                {#each gradelistEntries as yawa}
                    <tr>
                        ...
                        <td>{yawa.ParticipationScore.participation_1}</td>
                        <td>{yawa.ParticipationScore.participation_2}</td>
                        <td>{yawa.ParticipationScore.participation_3}</td>
                        <td>{yawa.ParticipationScore.participation_4}</td>
                        <td>{yawa.ParticipationScore.participation_5}</td>
                        <td>{yawa.ParticipationScore.participation_6}</td>
                        <td>{yawa.ParticipationScore.participation_7}</td>
                        <td>{yawa.ParticipationScore.participation_8}</td>
                        <td>{yawa.ParticipationScore.participation_9}</td>
                        <td>{yawa.ParticipationScore.participation_10}</td>
                        <td>{yawa.ParticipationScore.participation_total}</td>
                        <td>{yawa.ParticipationScore.participation_percentage}</td>
                    </tr>
                {/each}
            </tbody>
        </table>
