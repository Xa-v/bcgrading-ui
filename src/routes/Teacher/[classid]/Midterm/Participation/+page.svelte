  ...
  onMount(async () => {
     ...
     await import('bootstrap/dist/js/bootstrap.bundle.min.js');
      ...
      const token = localStorage.getItem('jwtToken');
          ...
          const prelimsparticipation = await fetch(`http://localhost:4000/teacher/Midterm/Participation/${classid}`, {
              headers: {
                  'Authorization': `Bearer ${token}` // Include JWT token
              }
          });
              ...
              <div class="row mt-3">
                  ...
                  <div class="col-md-4">
                      <div class="acard card rounded-0 text-center mb-3 shadow-sm" style="width: 15rem; height: 7rem;">
                          <a href={`/Teacher/${classid}/Midterm/Participation/${participation.gradeid}`} style="text-decoration: none; color: inherit;">
