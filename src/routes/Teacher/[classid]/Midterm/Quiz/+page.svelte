...
<!-- <div class="card rounded-0 shadow-sm mb-2">
  <div class="card-body"> -->
      ...
      <ul class="nav nav-tabs rounded-0 d-flex" id="myTab" role="tablist">
          ...
          <li class="nav-item flex-grow-1">
              <a class="nav-link active disabled rounded-0 border text-center" href={`/Teacher/${classid}/Midterm/Quiz`} role="tab" aria-selected="false">QUIZ</a>
          </li>
          <li class="nav-item flex-grow-1">
              ...
              <div class="row mt-3">
                  ...
                  <div class="col-md-4">
                      <div class="acard card rounded-0 text-center mb-3 shadow-sm" style="width: 15rem; height: 7rem;">
                          <a href={`/Teacher/${classid}/Midterm/Quiz/${quiz.gradeid}`} style="text-decoration: none; color: inherit;">
