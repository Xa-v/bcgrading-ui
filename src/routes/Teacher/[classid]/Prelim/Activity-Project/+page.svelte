    ...
    sessionStorage.clear();
     ...
     await import('bootstrap/dist/js/bootstrap.bundle.min.js');
      ...
      const token = localStorage.getItem('jwtToken');
          ...
          const prelimactivityproject = await fetch(`http://localhost:4000/teacher/Prelim/Activity/${classid}`, {
              headers: {
                  'Authorization': `Bearer ${token}` // Include JWT token
              }
          });
          ...
          if (prelimactivityproject.ok) {
              activityprojectprelim = await prelimactivityproject.json();
          } else {
  ...
  <div class="card-body"> -->
      ...
      <div class="row">
        ...
        <div class="col-md-8" style="max-height: 50vh;">
            <div class="row mt-3">
                {#each activityprojectprelim as activity}
                <div class="col-md-3">
                    <div class="acard card rounded-0 text-center mb-3 shadow-sm">
                        <a href={`/Teacher/${classid}/Prelim/Activity-Project/${activity.gradeid}`} style="text-decoration: none; color: inherit;">
                          <div class="card-body p-2 pb-4">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <p class="m-0 p-2">{activity.scoretype}</p>
                                </div>
                                <div class="dropdown">
                            ...
                            <strong class="mt-2 pt-2"> {new Date(activity.created).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</strong>
                        </div>
