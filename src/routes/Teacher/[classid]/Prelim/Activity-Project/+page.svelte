  ...
  <div class="card-body">
      ...
      <div class="row">
          ...
          <div class="col-md-8" style="max-height: 50vh; overflow-y: auto;">
              <div class="row mt-3">
                  {#each activityprojectprelim as activityproject}
                  <div class="col-md-4">
                      <div class="acard card rounded-0 text-center mb-3 shadow-sm" style="width: 15rem; height: 7rem;">
                          <a href={`/Teacher/${classid}/Prelim/Activity-Project/${activityproject.gradeid}`} style="text-decoration: none; color: inherit;">
