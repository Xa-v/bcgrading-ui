                          ...
                          <a href={`/Teacher/${classid}/Prelim/Participation/${participation.gradeid}`} style="text-decoration: none; color: inherit;">
                            <div class="card-body p-2 pb-4">
                              <div class="d-flex justify-content-between align-items-center">
                                  <div>
                                      <p class="m-0 p-2">{participation.scoretype}</p>
                                  </div>
                                  <div class="dropdown">
                              ...
                              <strong class="mt-2 pt-2"> {new Date(participation.created).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</strong>
                          </div>
