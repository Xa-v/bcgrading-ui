<script>
    ...
    let classinfo = [];
    let activityprojectscoresfinals = [];
    let error = '';
    let userRole = '';
    ...
    <div class="card rounded-0 shadow-sm mb-2">
      <div class="card-body">
        ...
        <ul class="nav nav-tabs rounded-0 d-flex" id="myTab" role="tablist">
          ...
          <li class="nav-item flex-grow-1">
            <a class="nav-link active disabled rounded-0 border  text-center" href={`/Teacher/${classid}/Final/Activity-Project`} role="tab" aria-selected="false">ACTIVITY/PROJECT</a>
        </li>
        <li class="nav-item flex-grow-1">
         ...
         <div style="max-height: 42vh; overflow-y: auto; overflow-x: hidden;">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    {#each activityprojectscoresfinals as activityproject}
                    <tr>
