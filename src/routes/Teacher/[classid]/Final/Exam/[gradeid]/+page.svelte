    ...
    onMount(async () => {
       ...
       await import('bootstrap/dist/js/bootstrap.bundle.min.js');
        ...
        const token = localStorage.getItem('jwtToken');
            ...
            if (examscores.ok) {
                examscoremidterm = await examscores.json();
            } else {
    ...
    <div class="card rounded-0 shadow-sm mb-2">
      <div class="card-body">
        ...
        <div class="d-flex justify-content-start gap-4 mb-1">
          ...
          <a class="btn btn-sm rounded-0 btn-primary  p-2 mb-3"  href={`/Teacher/${1}/Final/Exam`}>
            ←  go back to Exam 
          </a>
        ...
        <li class="nav-item flex-grow-1">
          <a class="nav-link active disabled rounded-0 border  text-center" href={`/Teacher/${classid}/Final/Exam`} role="tab" aria-selected="false">EXAM</a>
      </li>
      </ul>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{exam.Studentlist?.studentinfo?.lastName}</td>
                        <td>{exam.Studentlist?.studentinfo?.firstName}</td>
                        <td>{exam.Studentlist?.studentinfo?.id}</td>
                    </tr>
                    {/each}
                </tbody>
            </table>
